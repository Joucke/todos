                    ...
                    <div class="p-6">
                        <form method="POST" action="{{ route('groups.task-lists.tasks.store', [$group, $taskList]) }}" class="space-y-6">
                            ...
                            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <button type="submit"
                                        class="px-6 py-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-medium rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                                    Create Task
                                </button>
                            </div>
                        </form>
